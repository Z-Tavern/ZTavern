...
set_afk(value) {
    ...
    if (value) {
        ...
        self SetWeaponAmmoStock(self.useweapon, 0);
        self SetWeaponAmmoClip(self.useweapon, 0);
        self enableInvulnerability();
    } else {
        self setmovespeedscale(1);
        self SetWeaponAmmoStock(self.useweapon, stock);
        self SetWeaponAmmoClip(self.useweapon, clip);
