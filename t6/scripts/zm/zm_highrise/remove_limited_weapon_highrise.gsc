...
main ()
{
    replaceFunc(maps\mp\zm_highrise::include_weapons, ::include_weapons_highrise_custom);
}

include_weapons_highrise_custom()
{
    ...
    include_weapon( "an94_zm", 1 );
    include_weapon( "cymbal_monkey_zm" );
    include_weapon( "ray_gun_zm" );
    include_weapon( "ray_gun_upgraded_zm", 0 );
    include_weapon( "slipgun_zm", 1 );
