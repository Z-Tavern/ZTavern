...
{
    fire = (9463, -8560, -398);
    ice = (11211, -7058.7, -345.875);
    wind = (11253, -8655, -408);
    lightning = (9623.4, -7016.2, -345.875);
    crazy = (10341.6, -7907.17, -411.875);
    ...
    self.closest_player_override = scripts\zm\zm_tomb\boss_ivo1::get_favorite_enemy_custom;
...
#/
        //iPrintLnBold("INCOMING PANZER!");
        //places = array( ice, fire, lightning, wind, crazy);
        random = level.places[randomint(level.places.size)];
        self animscripted( random , (0, 0, 0), "zm_spawn" );
        //self delete();
        //return;
    }
    ...
    self forceteleport( crazy, (0, 0, 0) );
  /*  foreach( player in level.players)
    {
        player shellshock( "lava_small", 3 );
    }*/
    ...
    //self animscripted( (10314.5, -7889.91, -411.875), (0, 0, 0), "zm_spawn" );
