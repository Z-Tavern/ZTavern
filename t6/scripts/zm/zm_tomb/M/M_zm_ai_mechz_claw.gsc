...
claw_grapple()
{
    ...
    n_time = n_dist / 1800;//Hook Launch speed
    ...
    do
    {
        ...
        foreach ( player in a_players )
        {
            ...
            if ( n_dist_sq < 2304 )
            {
                ...
                {
                    self.e_grabbed = player;self setcandamage( 0 );
    ...
    wait 0.5;//after grab idle time and wait time for hook before pulling

    if ( isdefined( self.e_grabbed ) )
        n_time = n_dist / 100000;//pull player time
    else
        n_time = n_dist / 100000;//pull empty time
    ...
    self.fx_field = self.fx_field & ~256;
    //self.fx_field = self.fx_field & ~300;
    self setclientfield( "mechz_fx", self.fx_field );
...
#/
    ...
    if ( n_dist_sq < 60000 || n_dist_sq > 2000000 )
    {
/#
        if ( getdvarint( #"_id_E7121222" ) > 1 )
